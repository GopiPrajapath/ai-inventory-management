      ...
      <Card>
        ...
        <CardFooter>
          <Pagination>
            <PaginationContent>
              <PaginationItem>
                <PaginationPrevious size="sm" onClick={() => paginate(currentPage - 1)} />
              </PaginationItem>
              {Array.from({ length: Math.ceil(filteredItems.length / itemsPerPage) }, (_, index) => (
                <PaginationItem key={index + 1}>
                  <PaginationLink size="sm" onClick={() => paginate(index + 1)}>
                    {index + 1}
                  </PaginationLink>
                </PaginationItem>
              ))}
              <PaginationItem>
                <PaginationNext size="sm" onClick={() => paginate(currentPage + 1)} />
              </PaginationItem>
            </PaginationContent>
          </Pagination>
        </CardFooter>
